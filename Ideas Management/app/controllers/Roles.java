...
public class Roles extends CoolCRUD {
	 ...
	 * 
	 * @return Role the Role that it's name was passed
	 */
	 ...
	 * @return list<String> list actions of that role
	 */
	...
	public static List<String> getRoleActions(String roleName) {
		...
		Role role = Role.find("select r from Role r where r.roleName = ? ",
				roleName).first();
		// }
	...
	/**
	 * returns the list of Organizer actions that are related to Topics not the
	 * whole entity
	 * 
	 * @author nada ossama
	 * 
	...
	public static List<String> getOrganizerTopicActions() {
		...
		for (int i = 12; i < allActions.size(); i++) {
