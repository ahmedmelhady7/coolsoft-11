...
//}
/////////////////////////////////////////////////////////////////////////////
////// shabab 2na ma3reftesh 2a3ml commit 3del 3ashan 2l 7aga kolaha commented f this is the file i wanted to commit all the following 
/*<<<<<<< .mine
import java.util.ArrayList;
import java.util.Date;
import java.util.List;
...
public class Search extends Controller {
	...
	*//**
	...
	public static void SearchResult() {
		...
		render(connected, listOfResults, ideasFound, organizationsFound,
	...
	*//**
	...
	public static void filter_options(){
		...
		render(listOfResults,filterResult,tobepassed);
	}
