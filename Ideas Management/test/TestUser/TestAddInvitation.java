...
public class TestAddInvitation extends UnitTest {
	...
	public void addInvitationTest() {
		...
		User slim = new User("testslim.abdennadher@guc.edu.eg", "mezo", "1234",
				"Slim", "Abd EL Nadder", "What is our company's name?",
		...
		Topic studentUnion = new Topic("Student union", "Suggestions", 2, slim,
				met, true).save();
